		...
		try(Connection con = ds.getConnection();
			...
			try(ResultSet rs = pstmt.executeQuery();) {
				while(rs.next()) {
					...
					custom.setCustomerId(rs.getInt(1));
					custom.setCustomerName(rs.getString(2));
					custom.setCity(rs.getString(3));
					custom.setCountry(rs.getString(4));
					custom.setPostalCode(rs.getString(5));
